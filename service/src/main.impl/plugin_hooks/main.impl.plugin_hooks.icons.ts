import { StaticIconRepository, IconPluginHooks, PluginStaticIcon, StaticIconStub, UnregisteredStaticIcon, PluginResourceUrl } from '../../entities/icons/entities.icons'
